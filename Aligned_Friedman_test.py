# example of the Aligned Friedman Test with post-hoc analysis and Control method
from numpy.random import seed
from numpy.random import rand
from stac.nonparametric_tests import friedman_aligned_ranks_test
...
# compare samples
stat, p, rankings, pivots = friedman_aligned_ranks_test(data4, data1, data2, data3)
